...
namespace SummarizeDocumentAzureFunction
{
    ...
    {
        private static readonly AzureKeyCredential credentials = new AzureKeyCredential("18d224729dc64b7293bced8bd8e5e76b");
        private static readonly Uri endpoint = new Uri("https://text-analytics-bursaefek.cognitiveservices.azure.com/");
        ...
        static async Task TextSummarizationExample(TextAnalyticsClient client)
            ...
            string JSONString = string.Empty;
            JSONString = JsonConvert.SerializeObject(sbyte.ToString().Replace("\r\n"," "), Formatting.Indented)
            ...
            Return (ActionResult)new OkObjectResult(JSONString)
        {
            ...
            Console.WriteLine($"Status       : {operation.ExpiresOn}")
            ...
            await foreach (AnalyzeActionsResult documentsInPage in operation.Value)
            {
                ...
                foreach (ExtractSummaryActionResult summaryActionResults in summaryResults)
                {
                    ...
                    foreach (ExtractSummaryResult documentResults in summaryActionResults.DocumentsResults)
                    {
                        ...
                        Console.WriteLine();
                        Console.WriteLine($"Extracted The Following {documentResults.Sentences.Count} sentences(s):")
